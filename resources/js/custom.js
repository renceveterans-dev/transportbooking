...
function deleteItem(key, id, tablename) {
    ...
    $('#deleteDialog #negativeBtn').on('click', function() {
...
function updateStoreStatus(key, id, tablename, status, item) {

    $.ajax({
        url: "ajax/ajax_update_store_status.php",
        cache: false,
        type: "POST",
        data: {
            key: key,
...
function updateProductStatus(key, id, tablename, status) {

    $.ajax({
        url: "ajax/ajax_update_product_status.php",
        cache: false,
        type: "POST",
        data: {
            key: key,
...
function updateUserStatus(key, id, tablename, status) {

    $.ajax({
        url: "ajax/ajax_update_user_status.php",
        cache: false,
        type: "POST",
        data: {
            key: key,
