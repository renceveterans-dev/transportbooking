!function(e, i, t) {
    ...
    t(i).ready(function() {
      ...
      /*  t(".nav-toggle").on("click", function() {
            ...
            t(".nav-toggle").find(".toggle-icon").removeClass("ik-toggle-right").addClass("ik-toggle-left"),
            e.attr("data-toggle", "collapsed")) : (l.removeClass("nav-collapsed menu-collapsed"),
            t(".nav-toggle").find(".toggle-icon").removeClass("ik-toggle-left").addClass("ik-toggle-right"),
        ...
        /*s.on("mouseenter", function() {
            if (l.hasClass("nav-collapsed")) {
                ...
                n.find(".nav-item.active").parents(".nav-item").addClass("open"),
        ...
        t(e).resize(function() {
            t(e).width() < 992 && (s.addClass("hide-sidebar"),
            l.removeClass("nav-collapsed menu-collapsed")),
            t(e).width() > 992 && (s.removeClass("hide-sidebar"),
            "collapsed" === t(".toggle-icon").attr("data-toggle") && l.not(".nav-collapsed menu-collapsed") && l.addClass("nav-collapsed menu-collapsed"))
        }),
        ...
        t("#checkbox_select_all").on("click", function() {
            for (var e = i.getElementsByName("item_checkbox"), a = 0; a < e.length; a++)
        ...
        t(".list-item-wrap .list-item .list-title a").on("click", function(e) {
            t(".list-item.quick-view-opened").not(this).removeClass("quick-view-opened"),
            t(this).parents().parent(".list-item").toggleClass("quick-view-opened")
        }),
        ...
        document.addEventListener("click", function(e) {
            ...
            if (!(i.contains(e.target) || t.contains(e.target))) {
                ...
                for (var a = document.getElementsByClassName("right-sidebar-toggle"), s = 0; s < a.length; s++)
        ...
        if (c.length) {
            c.find(".chat-list").each(function(e) {
                ...
                $(this).find(".list-group a").on("click", function() {
                    ...
                    if (e.length) {
                        ...
                        t[0].classList.contains("scrollbar-enabled") && t.perfectScrollbar("update"),
                        e.find(".user-name").html($(this).data("chat-user"))
                    }
                })
            });
            var c;
            if ((c = $(".chat-panel")).length) {
                ...
                c.find(".minimize").on("click", function() {
                    c.find(".card-block").attr("hidden", !c.find(".card-block").attr("hidden")),
                    "hidden" === c.find(".card-block").attr("hidden") ? $(this).find(".material-icons").html("expand_less") : $(this).find(".material-icons").html("expand_more")
                });
                var d = $("a.view-grid")
                  , r = $("a.view-thumb")
                  , h = $("a.view-list")
                  , m = ($("ul.view-as"),
                $(".dispaly-option-buttons a"));
                d.click(function() {
